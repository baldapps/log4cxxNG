...
#ifndef _LOG4CXXNG_PATTERN_METHOD_LOCATION_PATTERN_CONVERTER
#define _LOG4CXXNG_PATTERN_METHOD_LOCATION_PATTERN_CONVERTER
 ...
 *
 */
class LOG4CXXNG_EXPORT MethodLocationPatternConverter
	: public LoggingEventPatternConverter
{
	...
	public:
		DECLARE_LOG4CXXNG_PATTERN(MethodLocationPatternConverter)
		BEGIN_LOG4CXXNG_CAST_MAP()
		LOG4CXXNG_CAST_ENTRY(MethodLocationPatternConverter)
