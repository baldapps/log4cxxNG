...
#ifndef _LOG4CXXNG_HELPERS_CHARSETDECODER_H
#define _LOG4CXXNG_HELPERS_CHARSETDECODER_H
...
LOG4CXXNG_PTR_DEF(CharsetDecoder);
class ByteBuffer;
...
*   into a LogString.
*/
class LOG4CXXNG_EXPORT CharsetDecoder : public ObjectImpl
{
	public:
		DECLARE_ABSTRACT_LOG4CXXNG_OBJECT(CharsetDecoder)
		BEGIN_LOG4CXXNG_CAST_MAP()
		LOG4CXXNG_CAST_ENTRY(CharsetDecoder)
