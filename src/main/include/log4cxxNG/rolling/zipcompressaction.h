...
#if !defined(_LOG4CXXNG_ROLLING_ZIP_COMPRESS_ACTION_H)
#define _LOG4CXXNG_ROLLING_ZIP_COMPRESS_ACTION_H
...
class ZipCompressAction : public Action
{
		...
		bool deleteSource;
	public:
		DECLARE_ABSTRACT_LOG4CXXNG_OBJECT(ZipCompressAction)
		BEGIN_LOG4CXXNG_CAST_MAP()
		LOG4CXXNG_CAST_ENTRY(ZipCompressAction)
...
LOG4CXXNG_PTR_DEF(ZipCompressAction);
